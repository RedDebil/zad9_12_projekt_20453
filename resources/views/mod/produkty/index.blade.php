    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="mb-6">
                        <form method="GET" action="{{ route('mod.produkty.index') }}" class="flex items-center space-x-4">
                            <div>
                            ...
                            @foreach($produkty as $produkt)
                                <tr>
                                    ...
                                    <td class="border-b p-2">
                                        <a href="{{ route('mod.opinie.index', $produkt->id) }}" class="text-indigo-600 hover:text-indigo-900">Zobacz opinie</a>
                                        <a href="{{ route('produkty.edit', $produkt->id) }}" class="text-indigo-600 hover:text-indigo-900">Edytuj</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
